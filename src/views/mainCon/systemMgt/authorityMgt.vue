        ...
        <div class="mainbox">
          <div class="leftmainbox">
            <div v-for="(item,index) in list" :key="index" class="item" 
                 @click="leftClick(index)" :class="index===curLeft?'active':''">{{item}}</div>
          </div>
        </div>
      </div>
      <div class="mid">
        ...
        <div class="mainbox">
          <div class="leftmainbox">
            <div v-for="(item,index1) in midList" :key="index1" class="item" 
                 @click="midClick(index1)" :class="index1===curMid?'active':''">{{item}}</div>
          </div>
        </div>
      </div>
      <div class="right">
